...
class TRENF_affine(tf.Module):
    ...
    def __init__(self, nc, bs=1., fitmean=True, fitnoise=False, nlayers=1, nknots=100, eps=1e-3, name=None, meanfield=True, linknots=False, fitscale=True, tfmode=0, minnoise=0.):
